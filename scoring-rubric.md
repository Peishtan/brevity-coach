...
Shape is assessed first. A well-compressed answer with the wrong structure is still the wrong answer. If shape fails badly, the other dimensions are secondary.

| Score | What it means |
|---|---|
| 9–10 | Correct shape, used precisely. Structure is invisible — the answer just flows. |
| 7–8 | Correct shape, minor deviation. One element misplaced or slightly out of proportion. |
| 5–6 | Partial shape. The right instinct but imprecise execution. Elements present but disordered or merged. |
| 3–4 | Wrong shape for the question type, or a recognised shape applied poorly. |
| 1–2 | No discernible structure. Answer wanders without a framework. |

**Root causes by score band:**

- **3–4:** Selected the wrong shape (e.g. used Present–Past–Future for a behavioural question), or started speaking before deciding on a structure.
- **1–2:** No shape selected. Thinking out loud. Processing while speaking rather than structuring before speaking.

**Common shape errors by question type:**

| Question type | Common error |
|---|---|
| Behavioural | Used Conclusion → Support instead of STAR. Gave an opinion instead of a story. |
| Opener | Gave a chronological CV instead of Present–Past–Future. |
...
### Brevity
*Did the answer avoid padding, repetition, and unnecessary context?*

Brevity is not about being short. It is about every sentence earning its place. A 130-word answer can score a 9 if every word is doing work. A 60-word answer can score a 4 if half the words are filler.
...
| 1–2 | Answer is dominated by filler. The core content is buried. Word count far exceeds the target with little added value. |

**Root causes by score band:**

- **7–8:** The speaker includes one supporting point more than necessary. Wants to be thorough. Hasn't yet trusted the listener to ask if they want more.
- **5–6:** Narrative hoarding. The speaker has a full story and feels compelled to tell all of it, even the parts that don't serve the answer.
- **3–4:** Status anxiety. More words feel safer. The speaker believes volume signals preparation and thoroughness. It signals the opposite.
- **1–2:** No editing instinct active. Speaking is treated as thinking rather than communicating.

**Filler patterns to flag:**

- Repeating the question back before answering it
- Summarising at the end what was already said ("So in summary, what I did was...")
...
Read the Action section back. Can you replace "First... Then... Finally..." with specific sentences about what the speaker did? If not, it's a list, not a sequence.

Strong sequence in STAR sounds like:
> "First I [specific action]. That surfaced [specific finding]. Then I [specific action in response]. That unlocked [specific outcome]. Finally I [specific closing action]."

Weak sequence sounds like:
> "I took ownership of the situation, worked with the team to get alignment, and made sure we delivered on time."
...
| 1–2 | Starting point. Go back to the shape first. Structure before compression. |
...
These root causes appear across multiple dimensions. Naming the root cause — not just the symptom — helps the user understand the pattern.
